...
```
autonomous-engineer/
├── SKILL.md                  <- THE COMPLETE SKILL: fully self-contained (~170 lines)
├── README.md
├── .gitignore
...
**Design Principle:** `SKILL.md` is a **single, self-contained file** (~170 lines) organized in 4 sections + 2 appendices. No external files, no registry, no templates directory. Installation is trivial (1 file) and the skill works identically across all supported agents.
